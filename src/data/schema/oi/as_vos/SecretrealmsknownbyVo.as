package model.genVo{
	...
	[Bindable]
	public dynamic class SecretrealmsknownbyVo implements IModelObject{

		private var _id:int;
		private var _secretrealmId:int;
		private var _realmId:int;

		public function SecretrealmsknownbyVo( id:int=0,
			secretrealmId:int=0,
			realmId:int=0) {

				_id=id;
				_secretrealmId=secretrealmId;
				_realmId=realmId;
		}
		...
		public function get secretrealmId():int {
			return _secretrealmId;
		}
		...
		public function set secretrealmId(value:int):void {
			_secretrealmId= value;
		}
		...
		public function getAsXMLString():String {
			var x:XML = <SecretrealmsknownbyVo/>;
			x.@id = _id;
			x.@secretrealmId = _secretrealmId;
			x.@realmId = _realmId;
		...
		public function getAsSubsetXMLString(omitProperties:Array):String {
           ...
           if(!contains(omitProperties, 'secretrealmId')){
			    x.@secretrealmId = _secretrealmId;
           }
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'secretrealmsknownby';
			var sortClause:String = '';

			sqlString = 'UPDATE secretrealmsknownby SET ' + 
				'secretrealm_id = '+secretrealmId.toString()+', ' + 
