package model.genVo{
	...
	[Bindable]
	public dynamic class RealmsnonhostilepartnersVo implements IModelObject{

		private var _id:int;
		private var _partnerRealm1Id:int;
		private var _partnerRealm2Id:int;

		public function RealmsnonhostilepartnersVo( id:int=0,
		...
		public function getAsXMLString():String {
			var x:XML = <RealmsnonhostilepartnersVo/>;
			x.@id = _id;
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'realmsnonhostilepartners';
			var sortClause:String = '';

			sqlString = 'UPDATE realmsnonhostilepartners SET ' + 
