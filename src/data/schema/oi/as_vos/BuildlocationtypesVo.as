package model.genVo{
	...
	[Bindable]
	public dynamic class BuildlocationtypesVo implements IModelObject{

		private var _id:int;
		private var _name:String;
		private var _code:String;

		public function BuildlocationtypesVo( id:int=0,
			name:String='',
			code:String='') {
		...
		public function getAsXMLString():String {
			var x:XML = <BuildlocationtypesVo/>;
			x.@id = _id;
			x.@name = _name;
			x.@code = _code;
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'buildlocationtypes';
			var sortClause:String = '';

			sqlString = 'UPDATE buildlocationtypes SET ' + 
				'name = "'+name.toString()+'", ' + 
				'code = "'+code.toString()+'" ' + 
