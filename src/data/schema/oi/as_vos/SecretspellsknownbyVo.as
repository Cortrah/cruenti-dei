package model.genVo{
	...
	[Bindable]
	public dynamic class SecretspellsknownbyVo implements IModelObject{

		private var _id:int;
		private var _spelltypeId:int;
		private var _realmId:int;

		public function SecretspellsknownbyVo( id:int=0,
			spelltypeId:int=0,
			realmId:int=0) {
		...
		public function getAsXMLString():String {
			var x:XML = <SecretspellsknownbyVo/>;
			x.@id = _id;
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'secretspellsknownby';
			var sortClause:String = '';

			sqlString = 'UPDATE secretspellsknownby SET ' + 
