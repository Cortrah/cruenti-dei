package model.genVo{
	...
	[Bindable]
	public dynamic class AgenttypesVo implements IModelObject{

		private var _id:int;
		private var _name:String;
		private var _code:String;

		public function AgenttypesVo( id:int=0,
			name:String='',
			code:String='') {
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'agenttypes';
			var sortClause:String = '';

			sqlString = 'UPDATE agenttypes SET ' + 
				'name = "'+name.toString()+'", ' + 
				'code = "'+code.toString()+'" ' + 
