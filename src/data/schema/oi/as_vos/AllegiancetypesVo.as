package model.genVo{
	...
	[Bindable]
	public dynamic class AllegiancetypesVo implements IModelObject{

		private var _id:int;
		private var _name:String;
		private var _code:String;

		public function AllegiancetypesVo( id:int=0,
			name:String='',
			code:String='') {
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'allegiancetypes';
			var sortClause:String = '';

			sqlString = 'UPDATE allegiancetypes SET ' + 
				'name = "'+name.toString()+'", ' + 
				'code = "'+code.toString()+'" ' + 
