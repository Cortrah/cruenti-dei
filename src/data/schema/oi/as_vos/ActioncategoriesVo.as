package model.genVo{
	...
	[Bindable]
	public dynamic class ActioncategoriesVo implements IModelObject{

		private var _id:int;
		private var _name:String;
		private var _code:String;

		public function ActioncategoriesVo( id:int=0,
			name:String='',
			code:String='') {
		...
		public function getSaveSql():String{
			...
			var tableName:String = 'actioncategories';
			var sortClause:String = '';

			sqlString = 'UPDATE actioncategories SET ' + 
				'name = "'+name.toString()+'", ' + 
				'code = "'+code.toString()+'" ' + 
